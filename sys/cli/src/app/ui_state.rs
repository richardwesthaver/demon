...
use tools::net::{Connection, LocalSocket, Utilization};
...
impl UiState {
  ...
  pub fn update(
    ...
    let total_bytes_downloaded: u128 = 0;
    let total_bytes_uploaded: u128 = 0;
    ...
    for state in self.utilization_data.iter().rev() {
      ...
      for (connection, connection_info) in &network_utilization.connections {
        ...
        data_for_remote_address.total_bytes_downloaded += connection_info.total_bytes_downloaded;
        ...
        self.total_bytes_downloaded += connection_info.total_bytes_downloaded;
        self.total_bytes_uploaded += connection_info.total_bytes_uploaded;
    ...
    if self.cumulative_mode {
      ...
      self.total_bytes_downloaded /= divide_by;
      self.total_bytes_uploaded /= divide_by;
    }
