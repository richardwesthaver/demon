...
**** Voice Generator
		 ...
		 It is strictly speaking [[https://en.wikipedia.org/wiki/Monotonic_function][monotonic]]. So for simplicity's sake, we
		 will use a single /[[https://en.wikipedia.org/wiki/Monophony][monophonic]]/ oscillator to represent all of our drum sounds
		 (kick, snare, hat, bleeps and bloops).
